...
<html>
  ...
  <body>
    <div id="all">
      ...
      <div id="content">
            ...
            <div class="row portfolio text-center">
              <div class="col-md-6">
                <div class="hospital-image">
                  <div class="image"><img src="img/A1.jpg" alt="" class="img-fluid">
              ...
              <div class="col-md-6">
                  ...
                  <div class="icon">
                    ...
                    <i class="fa fa-home fa-pull-left fa-2x fa-fw" aria-hidden="true"></i>A 동물병원<br><br>
                  </td>
                  </tr>
                  <tr>
                      <td>
                      <i class="fa fa-map-marker fa-pull-left fa-2x fa-fw" aria-hidden="true"></i>서울특별시 강남구 비트캠프<br><br><br>
                    </td>
                    </tr>
                    <tr>
                        <td>
                        <i class="fa fa-clock-o fa-pull-left fa-2x fa-fw" aria-hidden="true"></i>AM 09:00 ~ PM 09:00<br><br>
                      </td>
                      </tr>
                      <tr>
                          <td>
                          <i class="fa fa-laptop fa-pull-left fa-2x fa-fw" aria-hidden="true"></i>www.naver.com<br><br>
                        </td>
                        </tr>
                        <tr>
                            <td>
                            <i class="fa fa-car fa-pull-left fa-2x fa-fw" aria-hidden="true"></i>주차가능<br><br>
                          </td>
                          </tr>
                          <tr>
                              <td>
                              <i class="fa fa-plus fa-pull-left fa-2x fa-fw" aria-hidden="true"></i>응급진료<br><br>
                            </td>
                            </tr>
                  </div>
        ...
        <div class = "container">
          ...
          <div class="col-md-12">
            <div class="image"><img src="img/B1.jpeg" alt="" class="img-fluid" style="width: 1110px; height: 500px;"></div><br></br>
            </div>
          </div>
        </div>
        ...
        <div class = "container">
          <i class="fa fa-list fa-2x" aria-hidden="true"></i><span class="menu1" style="font-size:23px;">&nbsp;진료과목</span><br><br>
          <i class="fa fa-circle" aria-hidden="true"style=text-indent:100%;></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;종합 검진<br>
          <i class="fa fa-circle" aria-hidden="true"style=text-indent:100%;></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;수의 안과<br>
          <i class="fa fa-circle" aria-hidden="true"style=text-indent:100%;></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;피부과<br>
          <i class="fa fa-circle" aria-hidden="true"style=text-indent:100%;></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;치과<br>
          <i class="fa fa-circle" aria-hidden="true"style=text-indent:100%;></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;중성화 수술<br>
          <i class="fa fa-circle" aria-hidden="true"style=text-indent:100%;></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;예방 접종<br>
          <i class="fa fa-circle" aria-hidden="true"style=text-indent:100%;></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;응급 진료<br><br><br>
        </div>

        <div class = "container">
        <i class="fa fa-map-marker fa-3x" aria-hidden="true"></i><span class="menu1" style="font-size:23px;">&nbsp;찾아오시는길</span><br><br>
		...
		<div class = "container" >
		<i class="fa fa-comments fa-3x" aria-hidden="true"></i><span class="menu1" style="font-size:23px;">&nbsp;한 줄로 말하기</span><br><br>
	...
	<tr>
		...
		<td>
			&nbsp;&nbsp;&nbsp;
			<input style="width:90%; height:40px;" type="text" name="star_reply" />
			<input style="width:8%; height:30px;" type="submit" name="confirm" value="작성 완료" 
				onclick="" />
		</td>
	</tr>
	<tr>
