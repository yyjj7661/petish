				...
				<div class="row bar" style="overflow-x: auto;">
					<div id="customer-order" class="col-lg-20">
						<button class="btn btn-template-outlined" style="float: right;">
							<a href="/dog/freeboard/writeForm"> 글쓰기 </a>
						</button>
						<table class="table" style="margin: auto; text-align: center; max-width:100%;">
							<thead>
								<tr>
							...
							<tbody>
								...
								<tr>
									<td>98</td>
									<td>웃긴자료</td>
									<td colspan="10">안녕하세요%% &nbsp &nbsp <span
              ...
              <table class="table" style="margin:auto; text-align:center;">
                    ...
                    <tbody>
                       ...
                       <tr>
                        <td>98</td>
                       <td>웃긴자료</td>
                        <td colspan="10">안녕하세요%% &nbsp &nbsp <span class="badge badge-secondary">40</span></td>
                        <td>Pet</td>
                        <td>2019.07.01</td>
                        <td>11</td>  
                        <td>11</td>                                         
                        ...
                        <td>97</td>
                        <td>웃긴자료</td>
                        <td colspan="10">안녕하세요$$&nbsp &nbsp <span class="badge badge-secondary">82</span></td>
                        <td>Pet</td>
                        <td>2019.07.01</td>
                        <td>11</td>  
                        <td>11</td>                    
       ...
       <button class="btn btn-template-outlined">
	       ...
	       글쓰기
              ...
              <table class="table col-lg-20">
								...
								<tr>
									<td>98</td>
									<td class=test>웃긴자료</td>
									<td colspan="10">안녕하세요%% <span
										class="badge badge-secondary">72</span></td>
									<td>Pet</td>
									<td class=test>2019.07.01</td>
									<td class=test>11</td>
									<td class=test>11</td>
								...
								<tr>
									...
									<td class=test>웃긴자료</td>
									<td colspan="10">안녕하세요$$$<span
										class="badge badge-secondary">8</span></td>
									<td>Pet</td>
									<td class=test>2019.07.01</td>
									<td class=test>11</td>
									<td class=test>11</td>
								...
								<tr>
									...
									<td class=test></td>
									<td colspan="10">안녕하세요1##$<span
										class="badge badge-secondary">52</span></td>
									<td>Pet1</td>
									<td class=test>2019.07.01</td>
									<td class=test>11</td>
									<td class=test>11</td>
