					...
					<div id="customer-account">
						<div class="box mt-5" style="margin-top: 20px;">
							...
							<div class="col-lg-10 text-right p-3" style="display:inline-block;">
										<a href="/dog/infoboard/list" class="btn btn-template-outlined"
									...
									<div class="col-md-12">
										<div class="form-group">
											<label for="password_old">제목</label> <input id="password_old"
												type="text" value="강아지 훈련 꿀팁." class="form-control">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea id="summernote" class="form-control">간식준다</textarea>
										</div>
									</div>
