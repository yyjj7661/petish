...
<link href="/resources/css/infobaord/detail.css" rel="stylesheet">
			...
			<div class="container">
					...
					<div id="blog-post" class="col-md-13">
						...
						<button class="list btn btn-template-outlined">
							<i class="fa fa-align-justify"></i><a href="/dog/infoboard/list">목록</a>
						</button>
	
						<div class="panel-heading">
							<h2 class="h3 panel-title">배변훈련!!!!!!!!!!!!!!</h2>
						</div>
						...
						<table>
									...
									<td class=like><a href="#" class="btn btn-template-outlined"><i class="fa fa-heart-o"></i>15</a></td>
								</tr>
						</table>
									...
									<div class="col-sm-12 text-right">
										...
										<div aria-label="Page navigation example" class="d-flex justify-content-left">
											<button type="submit" class="btn btn-template-outlined">
												...
												<i class="fa fa-pencil"></i><a href="/dog/infoboard/modifyForm">수정</a>
											</button>
											<button type="submit" class="btn btn-template-outlined">
