		...
		<div id="heading-breadcrumbs">
			<div class="container">
				<div class="row d-flex align-items-center flex-wrap">
					<div class="col-md-7">
						<h1 class="h2">고양이 실종묘게시판</h1>
					</div>
					<div class="col-md-5">
						<ul class="breadcrumb d-flex justify-content-end">
							<li class="breadcrumb-item"><a href="index.html">고양이</a></li>
							<li class="breadcrumb-item active">실종묘게시판</li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div>
					<div id="customer-account">
						<div class="box mt-5" style="margin-top: 20px;">
							...
							<h4 style="display:inline-block;">[실종묘 정보]</h4>
							<div class="col-md-10 text-right" style="display:inline-block;">
								<input type="checkbox"><span style="color: red;"> 반려묘를 찾았습니다.</span>
							</div>
							<form id="missingMap">
								<div class="row">
