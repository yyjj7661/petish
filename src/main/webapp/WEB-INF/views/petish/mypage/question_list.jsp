			...
			<div id="navbar" role="navigation" class="navbar navbar-expand-lg">
				<div class="container">
					<a href="index.html" class="navbar-brand home"><img
						...
						src="./resources/img/logo-small.png" id="logo"
						...
						<div class="panel panel-default sidebar-menu">
							...
							<div class="panel-body">
								<ul class="nav nav-pills flex-column text-sm">
									...
									<li class="nav-item"><a href="questionList.html"
						...
						<h3>
							...
							<div class="text-right">
								<button class="btn btn-outline-primary"
									onclick="location.href='questionWrite.html'">문의하기</button>
							</div>
						</h3>
							<table class="table">
								...
								<tr>
									<th class="font-grey"><center>[등업관련]</center></th>
									<th><a href="" class="nondeco">아니 제가 5월에 등업관련 문의글을 남겼는데요</a></th>
									<th><span class="badge badge-danger">답변대기</span></th>
									<th class="font-grey"><center>19.07.04</center></th>
								</tr>
								<tr>
									<th class="font-grey"><center>[등업관련]</center></th>
									<th><a href="questionDetail.html" class="nondeco">정회원
											되려면 어떻게 해야하나요?</a></th>
									<th><span class="badge badge-danger">답변대기</span></th>
									<th class="font-grey"><center>19.05.30</center></th>
								</tr>
								<tr>
									<th class="font-grey"><center>[게시판 추가요청]</center></th>
									<th><a href="" class="nondeco">참새 자유게시판 요청합니다.</a></th>
									<th><span class="badge badge-info">답변완료</span></th>
									<th class="font-grey"><center>19.03.21</center></th>
								</tr>
								<tr>
									<th class="font-grey"><center>[게시판 추가요청]</center></th>
									<th><a href="" class="nondeco">도마뱀 자유게시판 요청합니다.</a></th>
									<th><span class="badge badge-info">답변완료</span></th>
									<th class="font-grey"><center>19.01.05</center></th>
								</tr>
