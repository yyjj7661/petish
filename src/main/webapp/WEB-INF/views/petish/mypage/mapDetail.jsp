...
<script>
function setZipcode(addr){
	opener.document.forms[1][6].value = addr
	self.close();
}
</script>
<body>
		...
		function getListItem(index, places) {
			...
			if (places.road_address_name) {
				itemStr += '<span>'
						...
						+ places.address_name
						+ '</span>'
						+ ' <input type="hidden" name="address" value="'+places.address_name+'"   >'
			} else {
			...
			el.onclick = function() {
				setZipcode(places.address_name + " " + places.place_name);
			}
