package com.community.petish.community.cat.gatherboard.service;
...
@Service("catGatherCommentService")
public class CatGatherCommentServiceImpl implements CatGatherCommentService{
